...
export const layananDatas: LayananData[] = [
  {
    ...
    badgeText: "Semua percakapan bersifat rahasia dan tidak dibagikan ke pihak manapun tanpa izinmu.",
  },
  {
    ...
    badgeText: "Tujuan utama bukan untuk memberikan solusi, tapi menjadi tempat aman untuk merasa tidak sendiri.",
  },
];
